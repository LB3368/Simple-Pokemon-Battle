// DOM Queries
//const startButton = document.querySelector('#start-button') moved button inside on div to have less code but keep same functionality
...
class Player {
    constructor(name, element) // needed when using 'class' because it is a reserved method for class
    {
        this.name = name
...
const game = {
    ...
    checkElement: function (evt) {
        evt.preventDefault()//in html must use the actual "event" (see line 51)
        //console.log("We clicked submit")
        //console.log(fName.value) - gives you the value of the input
        ...
        //Change player name
        //p1Name.textContent = fName.value
        //this.createPlayer() // "this" refers to the game object. points/refers back to the parent object.
    },
    clearForm: function() {
        fName.value = ""
        chosenEle.value = ""
    ...
    battle: function() {
        ...
        //     p1Ele.src = `images/${p1.element}.png`
        // }
        p1Ele.src = `../images/images/${p1}.png`
        p2Ele.src = `../images/images/${p2}.png`
    ...
    console.log(p1, p2)
        ...
        if(p1 === 'fire' && p2 === 'grass') {
            ...
            prompt.innerText = "Tie! We both died!!!!!"
        } else {
            prompt.innerText = `${pTwoName} is the winner!`
        }
    }
}
